...
#define MAX_LINEAR_SPEED_PERCENT 100.0f // [0-100] Velocità massima in percentuale
...
#define MAX_SPEED 95.0f                             // [0-100] Velocità massima motori
#define ROTATION_SPEED 30.0f                        // [0-100] Velocità di rotazione
...
#define CELL_FULL_VOLTAGE    4.2f   // V per cella a piena carica
#define CELL_EMPTY_VOLTAGE   3.0f   // V per cella scarica
#define CELL_LOW_VOLTAGE   3.3f   // V per cella (soglia di avviso batteria bassa)
#define CELL_CRITICAL_VOLTAGE 3.2f  // V per cella (soglia di spegnimento)

// Parametri calcolati
#define BATTERY_VOLTAGE_MAX       (BATTERY_CELLS * CELL_FULL_VOLTAGE)    // 4.2V per 1S
#define BATTERY_VOLTAGE_MIN       (BATTERY_CELLS * CELL_EMPTY_VOLTAGE)   // 3.0V per 1S
#define BATTERY_VOLTAGE_CRITICAL  (BATTERY_CELLS * CELL_CRITICAL_VOLTAGE) // 3.2V per 1S
